...
local function _Fugitive()
  keymap('n', '<Leader>ga',':Git add .<CR>', { noremap = true, silent = false })
  keymap('n', '<Leader>gb',':Git blame<CR>', { noremap = true, silent = false })
  keymap('n', '<Leader>gc',':Git commit -m ', { noremap = true, silent = false })
  keymap('n', '<Leader>gd',':Gvdiffsplit<CR>', { noremap = true, silent = false })
  keymap('n', '<Leader>gll',':Gllog<CR>', { noremap = true, silent = false })
  keymap('n', '<Leader>glc',':Gclog<CR>', { noremap = true, silent = false })
  keymap('n', '<Leader>gp',':Git push<CR>', { noremap = true, silent = false })
  keymap('n', '<Leader>gs',':Git status<CR>', { noremap = true, silent = false })
...
local function _Trouble()
  keymap('n', '<Leader>tt',':TroubleToggle<CR>', { noremap = true, silent = false })
  debugger.print("setuped trouble keymap")
end

local function _FzfLua()
  keymap('n', '<Leader>zf',':FzfLua files<CR>', { noremap = true, silent = false })
...
local function _VFiler()
  keymap('n', '<Leader>vf',':VFiler<CR>', { noremap = true, silent = false })
